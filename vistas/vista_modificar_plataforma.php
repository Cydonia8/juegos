...
<head>
    ...
    <title>Modificar plataforma | RPO</title>
</head>
<body id="seccion-usuarios">
    ...
    <button class="abrir-menu">
        ...
        <?php
            if(isset($success)){
                if($success){
                    echo "<h3 class=\"mensajes-temporales alert alert-success w-50 mx-auto mt-3\">Plataforma modificada</h3>";
                }else{
                    echo "<h3 class=\"mensajes-temporales alert alert-danger w-50 mx-auto mt-3\">Datos mal, ceporro</h3>";
                    if($foto_error){
                        echo "<h3 class=\"mensaje-temporal alert alert-danger w-50 mx-auto mt-3\">Formato o tamaño de foto inválidos</h3>"; 
                    }
                }
