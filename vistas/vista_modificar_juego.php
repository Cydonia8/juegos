...
<body id="seccion-usuarios">
    ...
    <button class="abrir-menu">
        ...
        <?php
            if(isset($success)){
                if($success){
                    echo "<h3 class=\"mensajes-temporales alert alert-success w-50\">Juego modificado</h3>";
                }else{
                    echo "<h3 class=\"mensajes-temporales alert alert-danger w-50 m-3\">Datos mal, ceporro</h3>";
                    if($foto_error){
